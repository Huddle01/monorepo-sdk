import { ArrowCircleRightIcon, ClipboardIcon, DuplicateIcon } from "@heroicons/react/outline";
  ...
  return (
    <>
      ...
      <div className="hidden xl:block">
        ...
        </div><div className="absolute top-[316px] left-[208.5px] h-12 w-12 ">
          {HomepageIcons.phantom}
        </div><div className="absolute top-[380px] left-[97px] h-12 w-12 ">
          {HomepageIcons.UD}
        </div><div className="absolute top-[188px] right-[207px] h-12 w-12 ">
          {HomepageIcons.nft}
        </div><div className="absolute top-[252px] right-[97px] h-12 w-12 ">
          {HomepageIcons.ethereum}
        </div><div className="absolute top-[316px] right-[208.5px] h-12 w-12 ">
          {HomepageIcons.ens}
        </div><div className="absolute top-[380px] right-[97px] h-12 w-12 ">
      ...
      <div className=" flex flex-col px-4 pt-16 pb-8 mx-auto sm:pt-24 lg:px-8">
        <div className="bg-custom-1 border border-slate-700 pr-3 pl-1 py-1 mx-auto border-1 items-center flex gap-2 rounded-3xl text-xs  mb-4">
          <div className="px-2 py-0.5 rounded-3xl bg-blue-500 font-semibold">Alpha Release</div>
        ...
        <p className="max-w-sm mx-auto mt-6 text-sm font-medium leading-tight text-center text-gray-400 ">
          We have done the heavy lifting so you can focus on building
          the best live audio & video experiences within few lines of code.
        </p>
      ...
      <div className="gridBack flex flex-col items-center justify-center mx-auto gap-32 px-5">
        <div className="flex flex-col justify-center items-center gap-12 ">
          <div className="flex flex-col gap-2 px-4">
            <h1 className="text-center text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#B0D9FF] to-[#3BB4E1] ">Right Out of the Box</h1>
            <p className=" text-sm font-normal text-slate-400 text-center">Get essential Audio/Video features to build powerful communication apps plus Web3 Features</p>
          </div>

          <div className="py-12 w-full px-8 rounded-2xl bg-custom-5 border border-slate-700 ">
            <Tabs.Root className="flex flex-col gap-3 md:gap-4 md:flex-row  w-full" defaultValue="f1">
              <Tabs.List className="flex md:flex-col gap-4 md:w-1/3 ">
                <Tabs.Trigger className="bg-custom-5 text-sm trigger text-left p-3 rounded-lg" value="f1">Feature 1</Tabs.Trigger>
                <Tabs.Trigger className="bg-custom-5 text-sm trigger text-left p-3 rounded-lg" value="f2">Feature 2</Tabs.Trigger>
                <Tabs.Trigger className="bg-custom-5 text-sm trigger text-left p-3 rounded-lg" value="f3">Feature 3</Tabs.Trigger>
              </Tabs.List>
              <Tabs.Content className="bg-custom-2 content rounded-lg h-80 w-full flex justify-center items-center" value="f1">Content 1</Tabs.Content>
              <Tabs.Content className="bg-custom-2 content rounded-lg h-80 w-full flex justify-center items-center" value="f2">Content 2</Tabs.Content>
              <Tabs.Content className="bg-custom-2 content rounded-lg h-80 w-full flex justify-center items-center" value="f3">Content 3</Tabs.Content>
            </Tabs.Root>
          </div>
        ...
        <div className="flex flex-col items-center justify-center gap-12 mb-10  md:mb-32">
          <div className="flex flex-col gap-2 px-4">
            <h1 className="text-3xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-[#E8CDFF]   to-[#FFA6AB]">Integrate/Build <br /> Blazingly Fast</h1>
            <p className="text-center text-sm font-normal text-slate-400">Designed for the Developers, By the Developers.
              To empower them build or leverage the
              Huddle01 Infra to ship Audio/Video quickly.</p>
          </div>

          <div className="grid grid-cols-1 gap-4 md:gap-8 md:grid-cols-2 place-items-center px-4">
            <div className=" h-64 w-80 lg:w-[560px] lg:h-80 border border-slate-700 bg-custom-5 rounded-2xl flex justify-center items-center lg:place-self-end " >GIF</div>
            <div className=" h-64 w-80 lg:w-[560px] lg:h-80 bg-custom-5 rounded-2xl border border-slate-700 flex justify-center items-center lg:place-self-start " >GIF</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 place-items-start md:place-items-center gap-4">
            <div className="flex items-center mx-6 gap-3 lg:place-self-end ">
              <span className="text-sm text-slate-400 font-medium">Available </span> {HomepageIcons.react} {HomepageIcons.reactNative}
            </div>

            <div className="flex items-center mx-6 gap-3 lg:place-self-start ">
              <span className="text-sm text-slate-400 font-medium">Coming Soon </span> {HomepageIcons.javascript}{HomepageIcons.android}{HomepageIcons.ios}{HomepageIcons.flutter}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-2 text-center px-4">
              <div className="flex justify-between">
                <Image src='/images/CloudL.png' className=" self-start" width={90} height={60} />
                <h1 className=" text-3xl font-extrabold self-end text-transparent bg-clip-text bg-gradient-to-r from-[#F8A3A3] to-[#98ECFF]">Tailored for your Needs</h1>
                <Image src='/images/cloudR.png' className=" self-start" width={90} height={60} />
              </div>

              <p className="text-sm font-normal ">Sky is the limit when you build via Huddle01 SDK. Build according to your usecase, or go beyond and ship something crazy!</p>
            </div>

            <div className="mx-4">
              <Tabs.Root className="flex flex-col gap-3 md:gap-4  w-full" defaultValue="f1">
                <Tabs.List className="flex gap-4 md:w-full pb-1 border-b-[1px] justify-center border-slate-700 ">
                  <Tabs.Trigger className="bg-custom-5 text-base trigger2 text-left py-2 px-6 rounded-lg" value="f1">Case</Tabs.Trigger>
                  <Tabs.Trigger className="bg-custom-5 text-base trigger2 text-left py-2 px-6 rounded-lg" value="f2">Case</Tabs.Trigger>
                  <Tabs.Trigger className="bg-custom-5 text-base trigger2 text-left py-2 px-6 rounded-lg" value="f3">Case</Tabs.Trigger>
                </Tabs.List>
                <Tabs.Content className="flex content flex-col md:flex-row md:items-center gap-4 mt-[52px]" value="f1">
                  <div>
                    <h1 className=" text-2xl font-bold text-slate-300">Heading 1</h1>
                    <p className="text-base font-normal text-slate-400">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo illum nostrum obcaecati repellendus quae, quidem saepe laboriosam quam nulla ab id qui, dolorum facere labore quos dicta fugit maxime placeat!</p>
                  </div>
                  <div className="bg-custom-2 h-80 rounded-xl w-full mt-4" />
                </Tabs.Content>
                <Tabs.Content className="flex content flex-col md:flex-row md:items-center gap-4 mt-[52px]" value="f2">
                  <div>
                    <h1 className=" text-2xl font-bold text-slate-300">Heading 2</h1>
                    <p className="text-base font-normal text-slate-400">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo illum nostrum obcaecati repellendus quae, quidem saepe laboriosam quam nulla ab id qui, dolorum facere labore quos dicta fugit maxime placeat!</p>
                  </div>
                  <div className="bg-custom-2 h-80 rounded-xl w-full mt-4" />
                </Tabs.Content>
                <Tabs.Content className="flex content flex-col md:flex-row md:items-center gap-4 mt-[52px]" value="f3">
                  <div>
                    <h1 className=" text-2xl font-bold text-slate-300">Heading 3</h1>
                    <p className="text-base font-normal text-slate-400">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo illum nostrum obcaecati repellendus quae, quidem saepe laboriosam quam nulla ab id qui, dolorum facere labore quos dicta fugit maxime placeat!</p>
                  </div>
                  <div className="bg-custom-2 h-80 rounded-xl w-full mt-4" />
                </Tabs.Content>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 md:grid-rows-2 place-content-center gap-4 px-4 w-full md:mt-52 md:w-2/3">
            <button className="flex justify-start items-start border border-slate-700 pt-5 pl-5 md:pb-24 pb-14 rounded-xl bg-custom-5 md:col-span-3 ">
              <a className="text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#98FFc1]   to-[#3BE191] ">Start Buidling</a>
            </button>
            <button className="flex justify-start items-start border border-slate-700 pt-5 pl-5 pb-14 md:pb-24 rounded-xl bg-custom-5 md:row-span-1 md:col-span-2 ">
              <a className="text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#B0D9FF]   to-[#3BB4E1] ">Pricing</a>
            </button>
            <button className="flex justify-start items-start border border-slate-700 pt-5 pl-5 pb-14 md:pb-24 rounded-xl bg-custom-5 md:col-start-1 md:col-span-2 ">
              <a className="text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#A0C6FF]   to-[#E7A1FF] ">About Us</a>
            </button>
            <button className="flex justify-start items-start border border-slate-700 pt-5 pl-5 pb-14 md:pb-24 rounded-xl bg-custom-5 md:col-span-3 ">
              <a className="text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#E8CDFF]   to-[#FFA6AB] ">Try Huddle01</a>
            </button>
          </div>
        </div>
      </div>
