...
Provider is necessary to initalise the `HuddleClient` Class which exposes all the [Client Methods](/sdk/web-sdk/methods) which is invoked for different use case.
