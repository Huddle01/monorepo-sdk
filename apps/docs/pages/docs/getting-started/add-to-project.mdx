...
Huddle01 can be easily integrated to any existing project to leverage the infrastructure of the Huddle01 platform.

> Make sure to have the prequisites installed ( Check out the [Getting Started](/getting-started) guide for more details )
